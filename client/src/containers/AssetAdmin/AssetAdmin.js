  ...
  hackInDemoIconSwitcher() {
    ...
    let interval = setInterval(() => {
      ...
      container.innerHTML = [
        ...
        '    <button class="demo-icon-switch-ico" data-value="person_key" style="font-size:10px;padding:5px;">person_key</button>',
        '    <button class="demo-icon-switch-ico" data-value="person_shield" style="font-size:10px;padding:5px;">person_shield</button>',
        '    <button class="demo-icon-switch-ico" data-value="eyelock" style="font-size:10px;padding:5px;">eyelock</button>',
        '    <button class="demo-icon-switch-ico" data-value="key" style="font-size:10px;padding:5px;">key</button>',
        '  </div>',
        // '  <div style="border-bottom: 1px solid grey; margin-bottom: 10px; padding-bottom: 10px;">',
