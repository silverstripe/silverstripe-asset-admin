...
p.default)(a,c.fileInterface,c.file,c.folder),m={options:function e(t){var n=t.sectionConfig,r=t.folderId,o=t.fileId,a=t.query,l={id:r,anyChildId:o||null},u=a.sort?a.sort.split(","):["",""],p=s(u,2),d=p[0],c=p[1],h=a.filter||{},m=a.limit||n.limit


return{variables:{rootFilter:l,childrenFilter:i(h,{parentId:void 0,recursive:(0,f.hasFilters)(h),currentFolderOnly:void 0}),limit:m,offset:((a.page||1)-1)*m,sortBy:d&&c?[{field:d,direction:c.toUpperCase()
