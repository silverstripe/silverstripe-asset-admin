...
value:function _(){if(0===this.props.files.length&&!this.props.loading)return p["default"].createElement("p",{className:"gallery__no-item-notice"},h["default"]._t("AssetAdmin.NOITEMSFOUND"))}},{key:"renderSize",
