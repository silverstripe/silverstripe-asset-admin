...
return b["default"].createElement("div",{className:"fill-height"},b["default"].createElement(z["default"],{showBackButton:e,handleBackButtonClick:this.handleBackButtonClick},b["default"].createElement(M["default"],{
multiline:!0}),b["default"].createElement("div",{className:"asset-admin__toolbar-extra pull-xs-right fill-width"},b["default"].createElement(W["default"],{onSearch:this.handleDoSearch,id:"AssetSearchForm",
searchFormSchemaUrl:t,folderId:this.props.folderId,filters:n}),this.props.toolbarChildren)),b["default"].createElement("div",{className:"flexbox-area-grow fill-width fill-height gallery"},this.renderGallery(),this.renderEditor()),"admin"!==this.props.type&&this.props.loading&&[b["default"].createElement("div",{
...
function r(e){return e&&e.__esModule?e:{"default":e}}var o=n(22),i=r(o),s=n(4),a=r(s),l=n(23),u=r(l),p=n(277),c=n(410),d=n(400)
