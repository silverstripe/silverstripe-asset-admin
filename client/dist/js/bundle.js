...
case d["default"].LOAD_FOLDER_REQUEST:return(0,s["default"])(l({},e,{folderId:t.payload.folderId,selectedFiles:[],files:[],count:0,loading:!0}))
...
t["default"]=r
var a=n(7),s=i(a),u=n(8),d=i(u),p={count:0,editorFields:[],file:null,files:[],fileId:0,folderId:0,focus:!1,path:null,selectedFiles:[],page:0}},function(e,t){e.exports=DeepFreezeStrict},function(e,t){"use strict"
...
case d["default"].FAIL_UPLOAD:return(0,s["default"])(l({},e,{items:e.items.map(function(e){return e.queuedAtTime===t.payload.queuedAtTime?l({},e,{messages:[{value:c["default"]._t("AssetAdmin.DROPZONE_FAILED_UPLOAD"),
type:"error",extraClass:"error"}]}):e})}))
...
key:"handleAction",value:function i(e,t,n){return"action_addtocampaign"===t?(this.openModal(),void e.preventDefault()):"action_delete"===t?(this.props.onDelete(n.ID),void e.preventDefault()):void 0}},{
key:"handleCancelKeyDown",value:function s(e){e.keyCode!==m["default"].SPACE_KEY_CODE&&e.keyCode!==m["default"].RETURN_KEY_CODE||this.handleClose(e)}},{key:"handleSubmit",value:function d(e,t,n){return"function"==typeof this.props.onSubmit?this.props.onSubmit(e,t,n):(e.preventDefault(),
n())}},{key:"handleSubmitModal",value:function c(e,t,n){return e.preventDefault(),t.Campaign?n():(alert(u["default"]._t("AddToCampaigns.ErrorCampaignNotSelected","There was no campaign selected to be added to")),
...
},callback:null}],BULK_ACTIONS_PLACEHOLDER:o["default"]._t("AssetAdmin.BULK_ACTIONS_PLACEHOLDER"),SPACE_KEY_CODE:32,RETURN_KEY_CODE:13}},function(e,t){e.exports=FormBuilderModal},function(e,t,n){"use strict"
...
if(r<o)return 1}return 0}}function u(e){var t=e.assetAdmin.gallery,n=t.loading,i=t.count,r=t.files,o=t.selectedFiles,l=t.page
return{loading:n,count:i,files:r,selectedFiles:o,page:l,queuedFiles:e.assetAdmin.queuedFiles}}function d(e){return{actions:{gallery:(0,D.bindActionCreators)(z,e),queuedFiles:(0,D.bindActionCreators)(q,e)
...
}},{key:"handleSending",value:function C(e,t){this.props.actions.queuedFiles.updateQueuedFile(e._queuedAtTime,{xhr:t})}},{key:"handleUploadProgress",value:function S(e,t){this.props.actions.queuedFiles.updateQueuedFile(e._queuedAtTime,{
...
value:function B(e,t){e.preventDefault(),null!==t.created&&this.props.onOpenFile(t.id,t)}},{key:"handleToggleSelect",value:function Q(e,t){this.props.selectedFiles.indexOf(t.id)===-1?this.props.actions.gallery.selectFiles([t.id]):this.props.actions.gallery.deselectFiles([t.id])

}},{key:"handleMoreClick",value:function H(e){e.stopPropagation(),e.preventDefault(),this.props.actions.gallery.deselectFiles()}},{key:"handleBackClick",value:function W(e){e.preventDefault()
...
id:"upload-button",className:"btn btn-secondary font-icon-upload btn--icon-xl",type:"button",disabled:!i},v["default"].createElement("span",{className:"btn__text"},g["default"]._t("AssetAdmin.DROPZONE_UPLOAD"))),v["default"].createElement("button",{
id:"add-folder-button",className:"btn btn-secondary font-icon-folder-add btn--icon-xl ",type:"button",onClick:this.handleCreateFolder,disabled:!i},v["default"].createElement("span",{className:"btn__text"
},g["default"]._t("AssetAdmin.ADD_FOLDER_BUTTON")))),v["default"].createElement(k["default"],{canUpload:i,handleAddedFile:this.handleAddedFile,handleError:this.handleFailedUpload,handleSuccess:this.handleSuccessfulUpload,
handleSending:this.handleSending,handleUploadProgress:this.handleUploadProgress,folderId:this.props.folderId,options:t,securityID:n,uploadButton:!1},v["default"].createElement("div",{className:"gallery__folders"
...
n.handleUploadProgress=n.handleUploadProgress.bind(n),n.handleError=n.handleError.bind(n),n.handleSending=n.handleSending.bind(n),n.handleSuccess=n.handleSuccess.bind(n),n}return l(t,e),s(t,[{key:"componentDidMount",
value:function n(){u(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),"componentDidMount",this).call(this)
...
return t.props.handleAddedFile(i),t.dropzone.processFile(e),i})}},{key:"loadImage",value:function T(e,t){return new Promise(function(n){e.onload=function(){var t=document.createElement("canvas"),i=t.getContext("2d")


t.width=e.naturalWidth,t.height=e.naturalHeight,i.drawImage(e,0,0,t.width,t.height)
var r=t.toDataURL()
n({width:t.width,height:t.height,thumbnailURL:r})},e.src=t})}},{key:"handleError",value:function D(e,t){"function"==typeof this.props.handleSending&&this.props.handleError(e,t)}},{key:"handleSuccess",value:function C(e){
this.props.handleSuccess(e)}},{key:"setPromptOnRemove",value:function O(e){this.dropzone.options.dictRemoveFileConfirmation=e}}]),t}(m["default"])
...
v="Invalid JSON response from server."}return E(),200<=(r=F.status)&&r<300?n._finished(e,v,i):l()}}}(this),F.onerror=function(n){return function(){if(e[0].status!==t.CANCELED)return l()}}(this),y=null!=(I=F.upload)?I:F,
...
value:!0})
var a=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n]
i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),s=n(11),u=i(s),d=n(15),p=i(d),c=n(25),f=i(c),h=n(18),m=i(h),g=function(e){
function t(e){r(this,t)
var n=o(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
return e&&e.height<f["default"].THUMBNAIL_HEIGHT&&e.width<f["default"].THUMBNAIL_WIDTH}},{key:"handleKeyDown",value:function _(e){e.stopPropagation(),f["default"].SPACE_KEY_CODE===e.keyCode&&(e.preventDefault(),
...
function i(e){return e&&e.__esModule?e:{"default":e}}function r(e){return function(t){return t({type:p["default"].ADD_QUEUED_FILE,payload:{file:e}})}}function o(e){return function(t){return t({type:p["default"].FAIL_UPLOAD,
payload:{queuedAtTime:e}})}}function l(){return function(e){return e({type:p["default"].PURGE_UPLOAD_QUEUE,payload:null})}}function a(e){return function(t){return t({type:p["default"].REMOVE_QUEUED_FILE,
...
payload:{queuedAtTime:e,updates:t}})}}Object.defineProperty(t,"__esModule",{value:!0}),t.addQueuedFile=r,t.failUpload=o,t.purgeUploadQueue=l,t.removeQueuedFile=a,t.succeedUpload=s,t.updateQueuedFile=u
