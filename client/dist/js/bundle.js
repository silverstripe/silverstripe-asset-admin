...
n(1),n(32),n(41)},function(e,t,n){(function(t){e.exports=t.InsertMediaModal=n(2)}).call(t,function(){return this}())},function(e,t,n){"use strict"
...
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function a(e,t){var n=e.config.sections[A],r=t.fileAttributes.ID,i=e.config.sections[A],o=r&&i.form.FileInsertForm.schemaUrl+"/"+r
...
try{for(var l=e[Symbol.iterator](),s;!(r=(s=l.next()).done)&&(n.push(s.value),!t||n.length!==t);r=!0);}catch(a){i=!0,o=a}finally{try{!r&&l["return"]&&l["return"]()}finally{if(i)throw o}}return n}return function(t,n){
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),f=n(3),h=i(f),m=n(4),y=n(5),g=n(6),v=i(g),E=n(16),b=i(E),_=n(31),F=r(_),A="SilverStripe\\AssetAdmin\\Controller\\AssetAdmin",T=function(e){
function t(e){o(this,t)
var n=l(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
return n.handleSubmit=n.handleSubmit.bind(n),n.handleBrowse=n.handleBrowse.bind(n),n.getUrl=n.getUrl.bind(n),n.state={folderId:0,fileId:e.fileAttributes.ID,query:{}},n}return s(t,e),c(t,[{key:"componentWillMount",
...
this.setState({folderId:0,fileId:e.fileAttributes.ID}))}},{key:"componentWillUnmount",value:function i(){this.setOverrides()}},{key:"setOverrides",value:function a(e){if(e&&this.props.schemaUrl===e.schemaUrl||this.props.actions.schema.setSchemaStateOverrides(e.schemaUrl,null),
...
ID:f.PropTypes.number,AltText:f.PropTypes.string,Width:f.PropTypes.number,Height:f.PropTypes.number,TitleTooltip:f.PropTypes.string,Alignment:f.PropTypes.string}),fileId:f.PropTypes.number,onHide:f.PropTypes.bool,
className:f.PropTypes.string,actions:f.PropTypes.object},T.defaultProps={className:"",fileAttributes:{}},t.InsertMediaModal=T,t["default"]=(0,y.connect)(a,u)(T)},function(e,t){e.exports=React},function(e,t){
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function s(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function a(e,t){var n=e.assetAdmin.gallery.folder,r=e.assetAdmin.gallery.files


return{files:r,folder:n,limit:t.sectionConfig.limit,securityId:e.config.SecurityID}}function u(e){return{actions:{gallery:(0,m.bindActionCreators)(A,e),breadcrumbsActions:(0,m.bindActionCreators)(O,e)}
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),c=n(3),f=i(c),h=n(5),m=n(4),y=n(7),g=i(y),v=n(8),E=i(v),b=n(9),_=i(b),F=n(10),A=r(F),T=n(12),O=r(T),w=n(13),D=i(w),C=n(17),P=i(C),I=n(29),S=i(I),k=n(30),L=i(k),U=function(e){
function t(e){o(this,t)
var n=l(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
n.compare=n.compare.bind(n),n}return s(t,e),p(t,[{key:"componentWillMount",value:function n(){var e=this.props.sectionConfig
...
t&&this.setBreadcrumbs(e.folder)}},{key:"handleBrowse",value:function i(e,t,n){"function"==typeof this.props.onBrowse&&this.props.onBrowse(e,t,n)}},{key:"handleSort",value:function a(e){this.handleBrowse(this.props.folderId,this.props.fileId,{
...
value:function F(e){this.handleBrowse(e)}},{key:"delete",value:function A(e){var t=this,n=this.props.files.find(function(t){return t.id===e})
...
return f["default"].createElement(P["default"],{dialog:this.props.dialog,files:this.props.files,fileId:this.props.fileId,folderId:this.props.folderId,folder:this.props.folder,type:this.props.type,limit:r,
...
onOpenFile:this.handleOpenFile,onOpenFolder:this.handleOpenFolder,onSort:this.handleSort,sort:o,sectionConfig:e})}},{key:"renderEditor",value:function O(){var e=this,t=this.props.sectionConfig,n=this.props.files.find(function(t){
...
return n||this.props.fileId===this.props.folderId?f["default"].createElement(D["default"],{fileId:this.props.fileId,onClose:this.handleCloseFile,editFileSchemaUrl:r,onSubmit:this.handleSubmitEditor,onDelete:this["delete"],
addToCampaignSchemaUrl:t.form.AddToCampaignForm.schemaUrl}):null}},{key:"render",value:function w(){var e=!(!this.props.folder||!this.props.folder.id)
return f["default"].createElement("div",{className:"fill-height"},f["default"].createElement(L["default"],{showBackButton:e,handleBackButtonClick:this.handleBackButtonClick},f["default"].createElement(S["default"],{
...
U.propTypes={dialog:c.PropTypes["boolean"],sectionConfig:c.PropTypes.shape({url:c.PropTypes.string,limit:c.PropTypes.number,form:c.PropTypes.object}),fileId:c.PropTypes.number,folderId:c.PropTypes.number,
onBrowse:c.PropTypes.func,getUrl:c.PropTypes.func,query:c.PropTypes.shape({sort:c.PropTypes.string}),onSubmitEditor:c.PropTypes.func,type:c.PropTypes.oneOf(["insert","admin"]),files:c.PropTypes.array,folder:c.PropTypes.shape({
id:c.PropTypes.number,title:c.PropTypes.string,parents:c.PropTypes.array,parentID:c.PropTypes.number,canView:c.PropTypes.bool,canEdit:c.PropTypes.bool})},U.defaultProps={type:"admin"},t.AssetAdmin=U,t["default"]=(0,
h.connect)(a,u)(U)},function(e,t){e.exports=SilverStripeComponent},function(e,t){e.exports=Backend},function(e,t){e.exports=i18n},function(e,t,n){"use strict"
...
},folderId:parseInt(e.folderID,10)}}),e})["catch"](function(e){throw i({type:h["default"].LOAD_FOLDER_FAILURE,payload:{message:e.message}}),e})}}function s(){return{type:h["default"].UNLOAD_FOLDER}}function s(){
return{type:h["default"].UNLOAD_FOLDER}}function a(e,t){return function(n){n({type:h["default"].LOAD_FILE_SUCCESS,payload:{id:e,file:t}})}}function u(){var e=arguments.length<=0||void 0===arguments[0]?null:arguments[0]
...
t.unloadFolderContents=s,t.unloadFolderContents=s,t.loadFile=a,t.selectFiles=u,t.deselectFiles=d,t.sortFiles=p,t.createFolder=c
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),a=n(9),u=r(a),d=n(3),p=r(d),c=n(14),f=r(c),h=n(15),m=r(h),y=n(16),g=r(y),v=function(e){
...
n.openModal=n.openModal.bind(n),n.state={openModal:!1},n}return l(t,e),s(t,[{key:"getCancelButton",value:function n(){return p["default"].createElement("a",{tabIndex:"0",className:"btn btn--top-right btn--no-text font-icon-cancel btn--icon-xl",
onClick:this.handleClose,onKeyDown:this.handleCancelKeyDown,type:"button","aria-label":u["default"]._t("AssetAdmin.CANCEL")})}},{key:"handleAction",value:function r(e,t){var n=e.currentTarget.name
return"action_addtocampaign"===n?(this.openModal(),void e.preventDefault()):"action_delete"===n?(this.props.onDelete(t.ID),void e.preventDefault()):void 0}},{key:"handleCancelKeyDown",value:function a(e){
...
e&&e.preventDefault()}},{key:"render",value:function v(){var e=this.props.editFileSchemaUrl+"/"+this.props.fileId,t=this.props.addToCampaignSchemaUrl+"/"+this.props.fileId
return p["default"].createElement("div",{className:editorClasses.join(" ")},p["default"].createElement("div",{className:"editor__details"},p["default"].createElement(m["default"],{schemaUrl:e,afterMessages:this.getCancelButton(),
handleSubmit:this.handleSubmit,handleAction:this.handleAction}),p["default"].createElement(g["default"],{show:this.state.openModal,handleHide:this.closeModal,schemaUrl:t,bodyClassName:"modal__dialog",responseClassBad:"modal__response modal__response--error",
responseClassGood:"modal__response modal__response--good"})))}}]),t}(d.Component)
v.propTypes={fileId:p["default"].PropTypes.number.isRequired,onClose:p["default"].PropTypes.func.isRequired,onSubmit:p["default"].PropTypes.func.isRequired,onDelete:p["default"].PropTypes.func.isRequired,
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function s(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function a(e,t){return function(n,r){
...
return{loading:n,count:r,files:i,selectedFiles:o,errorMessage:l,queuedFiles:e.assetAdmin.queuedFiles,securityId:e.config.SecurityID}}function d(e){return{actions:{gallery:(0,O.bindActionCreators)(N,e),
queuedFiles:(0,O.bindActionCreators)(q,e)}}}Object.defineProperty(t,"__esModule",{value:!0}),t.Gallery=void 0
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),h=n(18),m=i(h),y=n(9),g=i(y),v=n(3),E=i(v),b=n(19),_=i(b),F=n(20),A=i(F),T=n(5),O=n(4),w=n(21),D=i(w),C=n(22),P=i(C),I=n(25),S=i(I),k=n(26),L=i(k),U=n(14),R=i(U),M=n(10),N=r(M),x=n(27),q=r(x),j=function(e){
function t(e){o(this,t)
var n=l(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
this.props.actions.gallery.sortFiles(a(i,o))}}},{key:"componentWillUpdate",value:function i(){var e=(0,m["default"])(_["default"].findDOMNode(this)).find(".gallery__sort .dropdown")
...
t.chosen({allow_single_deselect:!0,disable_search_threshold:20}),t.on("change",function(){return D["default"].Simulate.click(t.find(":selected")[0])}),this.refreshFolderIfNeeded(e),this.checkLoadingIndicator()
...
this.props.onSort(e.target.value))}},{key:"handleCancelUpload",value:function T(e){e.xhr.abort(),this.props.actions.queuedFiles.removeQueuedFile(e.queuedAtTime)}},{key:"handleRemoveErroredUpload",value:function O(e){
this.props.actions.queuedFiles.removeQueuedFile(e.queuedAtTime)}},{key:"handleAddedFile",value:function w(e){this.props.actions.queuedFiles.addQueuedFile(e)}},{key:"handleSending",value:function C(e,t){
this.props.actions.queuedFiles.updateQueuedFile(e._queuedAtTime,{xhr:t})}},{key:"handleUploadProgress",value:function I(e,t){this.props.actions.queuedFiles.updateQueuedFile(e._queuedAtTime,{progress:t})

}},{key:"handleCreateFolder",value:function k(e){var t=this,n=this.promptFolderName()
...
if(this.props.actions.queuedFiles.removeQueuedFile(e._queuedAtTime),this.props.actions.gallery.addFiles(t,this.props.count+1),"insert"===this.props.type&&!this.props.fileId&&0===this.props.queuedFiles.items.length){
var n=t.pop()
this.props.onOpenFile(n.id)}}},{key:"handleFailedUpload",value:function M(e,t){this.props.actions.queuedFiles.failUpload(e._queuedAtTime,t)}},{key:"handleItemDelete",value:function N(e,t){confirm(g["default"]._t("AssetAdmin.CONFIRMDELETE"))&&this.props.actions.gallery.deleteItems(this.props.deleteApi,[t.id])

}},{key:"promptFolderName",value:function x(){return prompt(g["default"]._t("AssetAdmin.PROMPTFOLDERNAME"))}},{key:"itemIsSelected",value:function q(e){return this.props.selectedFiles.indexOf(e)>-1}},{
key:"itemIsHighlighted",value:function j(e){return this.props.fileId===e}},{key:"handleFolderActivate",value:function B(e,t){e.preventDefault(),this.props.onOpenFolder(t.id)}},{key:"handleFileActivate",
...
return i.length>0&&"admin"===this.props.type?E["default"].createElement(A["default"],{transitionName:"bulk-actions",transitionEnterTimeout:R["default"].CSS_TRANSITION_TIME,transitionLeaveTimeout:R["default"].CSS_TRANSITION_TIME
},E["default"].createElement(L["default"],{actions:r,items:i,key:i.length>0})):null}},{key:"render",value:function Y(){var e=this
...
return this.props.dialog&&l.push("gallery__main--dialog"),E["default"].createElement("div",{className:"flexbox-area-grow gallery__outer"},this.renderBulkActions(),E["default"].createElement("div",{className:l.join(" ")
},this.renderSort(),this.renderToolbar(),E["default"].createElement(P["default"],{canUpload:i,handleAddedFile:this.handleAddedFile,handleError:this.handleFailedUpload,handleSuccess:this.handleSuccessfulUpload,
...
j.defaultProps={type:"admin"},j.propTypes={dialog:v.PropTypes["boolean"],fileId:v.PropTypes.number,folderId:v.PropTypes.number.isRequired,folder:v.PropTypes.shape({id:v.PropTypes.number,parentID:v.PropTypes.number,
...
errorMessage:v.PropTypes.string,securityId:v.PropTypes.string},t.Gallery=j,t["default"]=(0,T.connect)(u,d)(j)},function(e,t){e.exports=jQuery},function(e,t){e.exports=ReactDom},function(e,t){e.exports=ReactAddonsCssTransitionGroup
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),u=function A(e,t,n){null===e&&(e=Function.prototype)


var r=Object.getOwnPropertyDescriptor(e,t)
if(void 0===r){var i=Object.getPrototypeOf(e)
return null===i?void 0:A(i,t,n)}if("value"in r)return r.value
var o=r.get
if(void 0!==o)return o.call(n)},d=n(3),p=r(d),c=n(19),f=r(c),h=n(7),m=r(h),y=n(9),g=r(y),v=n(23),E=r(v),b=n(18),_=r(b),F=function(e){function t(e){i(this,t)
var n=o(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
n}return l(t,e),a(t,[{key:"componentDidMount",value:function n(){u(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),"componentDidMount",this).call(this)
var e=this.getDefaultOptions()
this.props.uploadButton===!0&&(e.clickable=(0,_["default"])(f["default"].findDOMNode(this)).find(".asset-dropzone__upload-button")[0]),this.dropzone=new E["default"](f["default"].findDOMNode(this),s({},e,this.props.options)),
"undefined"!=typeof this.props.promptOnRemove&&this.setPromptOnRemove(this.props.promptOnRemove)}},{key:"componentWillUnmount",value:function r(){u(t.prototype.__proto__||Object.getPrototypeOf(t.prototype),"componentWillUnmount",this).call(this),
...
return n.then(function(n){var r={dimensions:{height:n.height,width:n.width},category:t.getFileCategory(e.type),filename:e.name,queuedAtTime:e._queuedAtTime,size:e.size,title:e.name,type:e.type,url:n.thumbnailURL
}
return t.props.handleAddedFile(r),t.dropzone.processFile(e),r})}},{key:"loadImage",value:function T(e,t){var n=this
return new Promise(function(r){e.onload=function(){var t=document.createElement("canvas"),i=t.getContext("2d"),o=2*n.props.preview.width,l=2*n.props.preview.height,s=e.naturalWidth/e.naturalHeight
e.naturalWidth<o||e.naturalHeight<l?(t.width=e.naturalWidth,t.height=e.naturalHeight):s<1?(t.width=o,t.height=o/s):(t.width=l*s,t.height=l),i.drawImage(e,0,0,t.width,t.height)
var a=t.toDataURL("image/png")
r({width:e.naturalWidth,height:e.naturalHeight,thumbnailURL:a})},e.src=t})}},{key:"handleError",value:function O(e,t){"function"==typeof this.props.handleError&&this.props.handleError(e,t)}},{key:"handleSuccess",
value:function w(e){this.props.handleSuccess(e)}},{key:"setPromptOnRemove",value:function D(e){this.dropzone.options.dictRemoveFileConfirmation=e}}]),t}(m["default"])
...
var n,r,i,o,l,s,a,u,d=[].slice,p={}.hasOwnProperty,c=function(e,t){function n(){this.constructor=e}for(var r in t)p.call(t,r)&&(e[r]=t[r])
...
accept:function(e,t){return t()},init:function(){return a},forceFallback:!1,fallback:function(){var e,n,r,i,o,l
...
},addedfile:function(e){var n,r,i,o,l,s,a,u,d,p,c,f,h
...
this.previewsContainer.appendChild(e.previewElement),p=e.previewElement.querySelectorAll("[data-dz-name]"),o=0,a=p.length;o<a;o++)n=p[o],n.textContent=this._renameFilename(e.name)
...
return n.removeFile(e)}):n.removeFile(e)}}(this),f=e.previewElement.querySelectorAll("[data-dz-remove]"),h=[],s=0,d=f.length;s<d;s++)i=f[s],h.push(i.addEventListener("click",r))
...
return l}},errormultiple:a,processing:function(e){if(e.previewElement&&(e.previewElement.classList.add("dz-processing"),e._removeLink))return e._removeLink.textContent=this.options.dictCancelUpload},processingmultiple:a,
uploadprogress:function(e,t,n){var r,i,o,l,s
if(e.previewElement){for(l=e.previewElement.querySelectorAll("[data-dz-uploadprogress]"),s=[],i=0,o=l.length;i<o;i++)r=l[i],"PROGRESS"===r.nodeName?s.push(r.value=t):s.push(r.style.width=""+t+"%")
return s}},totaluploadprogress:a,sending:a,sendingmultiple:a,success:function(e){if(e.previewElement)return e.previewElement.classList.add("dz-success")},successmultiple:a,canceled:function(e){return this.emit("error",e,"Upload canceled.")
...
return o},t.prototype.init=function(){var e,n,r,i,o,l,s
...
return e.emit("addedfiles",n),r()})}}(this))(),this.URL=null!=(l=window.URL)?l:window.webkitURL,s=this.events,i=0,o=s.length;i<o;i++)e=s[i],this.on(e,this.options[e])
...
t.instances.splice(t.instances.indexOf(this),1)},t.prototype.updateTotalUploadProgress=function(){var e,t,n,r,i,o,l,s
if(r=0,n=0,e=this.getActiveFiles(),e.length){for(s=this.getActiveFiles(),o=0,l=s.length;o<l;o++)t=s[o],r+=t.upload.bytesSent,n+=t.upload.total
...
return i},t.prototype.enable=function(){return this.clickableElements.forEach(function(e){return e.classList.add("dz-clickable")}),this.setupEventListeners()},t.prototype.filesize=function(e){var t,n,r,i,o,l,s,a


if(r=0,i="b",e>0){for(l=["TB","GB","MB","KB","b"],n=s=0,a=l.length;s<a;n=++s)if(o=l[n],t=Math.pow(this.options.filesizeBase,4-n)/10,e>=t){r=e/Math.pow(this.options.filesizeBase,4-n),i=o
...
return i=document.createElement("img"),r&&(i.crossOrigin=r),i.onload=function(t){return function(){var r,o,l,a,u,d,p,c
...
r.width=l.trgWidth,r.height=l.trgHeight,s(o,i,null!=(u=l.srcX)?u:0,null!=(d=l.srcY)?d:0,l.srcWidth,l.srcHeight,null!=(p=l.trgX)?p:0,null!=(c=l.trgY)?c:0,l.trgWidth,l.trgHeight),a=r.toDataURL("image/png"),
t.emit("thumbnail",e,a),null!=n)return n()}}(this),null!=n&&(i.onerror=n),i.src=t},t.prototype.processQueue=function(){var e,t,n,r
...
return o}.call(this)},t.prototype.cancelUpload=function(e){var n,r,i,o,l,s,a
if(e.status===t.UPLOADING){for(r=this._getFilesWithXhr(e.xhr),i=0,l=r.length;i<l;i++)n=r[i],n.status=t.CANCELED
for(e.xhr.abort(),o=0,s=r.length;o<s;o++)n=r[o],this.emit("canceled",n)
...
var r,o,l,s,a,u,d,p,c,f,h,m,y,g,v,E,b,_,F,A,T,O,w,D,C,P,I,S,k,L,U,R,M,N
for(F=new XMLHttpRequest,A=0,D=e.length;A<D;A++)r=e[A],r.xhr=F
...
return o}}(this),E=function(t){return function(n){var i,o,l,s,a,u,d,p,c
if(null!=n)for(o=100*n.loaded/n.total,l=0,u=e.length;l<u;l++)r=e[l],r.upload={progress:o,total:n.total,bytesSent:n.loaded}
else{for(i=!0,o=100,s=0,d=e.length;s<d;s++)r=e[s],100===r.upload.progress&&r.upload.bytesSent===r.upload.total||(i=!1),r.upload.progress=o,r.upload.bytesSent=r.upload.total
if(i)return}for(c=[],a=0,p=e.length;a<p;a++)r=e[a],c.push(t.emit("uploadprogress",r,o,r.upload.bytesSent))
...
v="Invalid JSON response from server."}return E(),200<=(i=F.status)&&i<300?n._finished(e,v,r):l()}}}(this),F.onerror=function(n){return function(){if(e[0].status!==t.CANCELED)return l()}}(this),g=null!=(k=F.upload)?k:F,
...
for(s in u)a=u[s],a&&F.setRequestHeader(s,a)
if(o=new FormData,this.options.params){L=this.options.params
for(h in L)_=L[h],o.append(h,_)}for(T=0,C=e.length;T<C;T++)r=e[T],this.emit("sending",r,F,o)
if(this.options.uploadMultiple&&this.emit("sendingmultiple",e,F,o),"FORM"===this.element.tagName)for(U=this.element.querySelectorAll("input, textarea, select, button"),O=0,P=U.length;O<P;O++)if(p=U[O],
c=p.getAttribute("name"),f=p.getAttribute("type"),"SELECT"===p.tagName&&p.hasAttribute("multiple"))for(R=p.options,w=0,I=R.length;w<I;w++)y=R[w],y.selected&&o.append(c,y.value)
...
return n},n.getElements=function(e,t){var n,r,i,o,l,s,a,u
if(e instanceof Array){i=[]
try{for(o=0,s=e.length;o<s;o++)r=e[o],i.push(this.getElement(r,t))}catch(d){n=d,i=null}}else if("string"==typeof e)for(i=[],u=document.querySelectorAll(e),l=0,a=u.length;l<a;l++)r=u[l],i.push(r)
...
n.QUEUED="queued",n.ACCEPTED=n.QUEUED,n.UPLOADING="uploading",n.PROCESSING=n.UPLOADING,n.CANCELED="canceled",n.ERROR="error",n.SUCCESS="success",l=function(e){var t,n,r,i,o,l,s,a,u,d
for(s=e.naturalWidth,l=e.naturalHeight,n=document.createElement("canvas"),n.width=1,n.height=l,r=n.getContext("2d"),r.drawImage(e,0,0),i=r.getImageData(0,0,1,l).data,d=0,o=l,a=l;a>d;)t=i[4*(a-1)+3],0===t?o=a:d=a,
a=o+d>>1
return u=a/l,0===u?1:u},s=function(e,t,n,r,i,o,s,a,u,d){var p
return p=l(t),e.drawImage(t,n,r,i,o,s,a,u,d/p)},o=function(e,t){var n,r,i,o,l,s,a,u,d
if(i=!1,d=!0,r=e.document,u=r.documentElement,n=r.addEventListener?"addEventListener":"attachEvent",a=r.addEventListener?"removeEventListener":"detachEvent",s=r.addEventListener?"":"on",o=function(n){if("readystatechange"!==n.type||"complete"===r.readyState)return("load"===n.type?e:r)[a](s+n.type,o,!1),
!i&&(i=!0)?t.call(e,n.type||n):void 0},l=function(){var e
try{u.doScroll("left")}catch(t){return e=t,void setTimeout(l,50)}return o("poll")},"complete"!==r.readyState){if(r.createEventObject&&u.doScroll){try{d=!e.frameElement}catch(p){}d&&l()}return r[n](s+"DOMContentLoaded",o,!1),
r[n](s+"readystatechange",o,!1),e[n](s+"load",o,!1)}},n._autoDiscoverFunction=function(){if(n.autoDiscover)return n.discover()},o(window,n._autoDiscoverFunction)}).call(this)}).call(t,n(18),n(24)(e))},function(e,t){
...
value:!0})
var s=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n]
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),a=n(9),u=r(a),d=n(3),p=r(d),c=n(14),f=r(c),h=n(7),m=r(h),y=function(e){
function t(e){i(this,t)
var n=o(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
n.preventFocus=n.preventFocus.bind(n),n}return l(t,e),s(t,[{key:"handleActivate",value:function n(e){e.stopPropagation(),this.props.handleActivate(e,this.props.item)}},{key:"handleToggleSelect",value:function r(e){
e.stopPropagation(),e.preventDefault(),"function"==typeof this.props.handleToggleSelect&&this.props.handleToggleSelect(e,this.props.item)}},{key:"handleDelete",value:function a(e){this.props.handleDelete(e,this.props.item)
...
e.stopPropagation(),this.hasError()?this.props.handleRemoveErroredUpload(this.props.item):this.props.handleCancelUpload(this.props.item)}},{key:"getProgressBar",value:function O(){var e=null,t={className:"gallery-item__progress-bar",
style:{width:this.props.item.progress+"%"}}
return!this.hasError()&&this.uploading()&&(e=p["default"].createElement("div",{className:"gallery-item__upload-progress"},p["default"].createElement("div",t))),e}},{key:"render",value:function w(){var e=null,t=null,n=null
...
y.propTypes={item:d.PropTypes.shape({dimensions:d.PropTypes.shape({width:d.PropTypes.number,height:d.PropTypes.number}),category:d.PropTypes.oneOfType([d.PropTypes.bool,d.PropTypes.string]).isRequired,
id:d.PropTypes.number.isRequired,url:d.PropTypes.string,title:d.PropTypes.string.isRequired,progress:d.PropTypes.number}),highlighted:d.PropTypes.bool,selected:d.PropTypes.bool.isRequired,handleActivate:d.PropTypes.func.isRequired,
handleToggleSelect:d.PropTypes.func,handleDelete:d.PropTypes.func.isRequired,message:d.PropTypes.shape({value:d.PropTypes.string,type:d.PropTypes.string}),uploading:d.PropTypes.bool,selectable:d.PropTypes.bool
},t["default"]=y},function(e,t,n){"use strict"
function r(e){return e&&e.__esModule?e:{"default":e}}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function o(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called")


return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function l(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function s(e){return{gallery:e.assetAdmin.gallery
...
function t(e){i(this,t)
var n=o(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
return n.onChangeValue=n.onChangeValue.bind(n),n}return l(t,e),a(t,[{key:"componentDidMount",value:function n(){var e=(0,d["default"])(h["default"].findDOMNode(this)).find(".dropdown")
...
value:function s(e){return this.props.actions.find(function(t){return t.value===e})}},{key:"onChangeValue",value:function u(e){var t=this,n=null,r=this.getOptionByValue(e.target.value)
...
E.connect)(s)(b)},function(e,t,n){"use strict"
...
return"string"==typeof t&&(r={value:t,type:"error"}),n({type:p["default"].FAIL_UPLOAD,payload:{queuedAtTime:e,message:r}})}}function l(){return function(e){return e({type:p["default"].PURGE_UPLOAD_QUEUE,
payload:null})}}function s(e){return function(t){return t({type:p["default"].REMOVE_QUEUED_FILE,payload:{queuedAtTime:e}})}}function a(e){return function(t){return t({type:p["default"].SUCCEED_UPLOAD,payload:{
queuedAtTime:e}})}}function u(e,t){return function(n){return n({type:p["default"].UPDATE_QUEUED_FILE,payload:{queuedAtTime:e,updates:t}})}}Object.defineProperty(t,"__esModule",{value:!0}),t.addQueuedFile=i,
t.failUpload=o,t.purgeUploadQueue=l,t.removeQueuedFile=s,t.succeedUpload=a,t.updateQueuedFile=u
var d=n(28),p=r(d)},function(e,t){"use strict"
...
function r(e){return e&&e.__esModule?e:{"default":e}}var i=n(4),o=n(33),l=r(o),s=n(34),a=r(s),u=n(35),d=r(u),p=n(36),c=r(p),f=n(38),h=r(f),m=n(39),y=r(m)
...
a["default"].add({path:e.url,component:y["default"],indexRoute:{onEnter:function t(n,r){var i=[e.url,"show",0].join("/")
...
queuedFiles:h["default"]}))})},function(e,t){e.exports=Config},function(e,t){e.exports=ReactRouteRegister},function(e,t){e.exports=ReducerRegister},function(e,t,n){"use strict"
...
e.files.forEach(function(e){e.id===t.id&&(r=!0)}),r||n.push(t)}),{v:(0,a["default"])(l({},e,{count:"undefined"!=typeof t.payload.count?t.payload.count:e.count,files:n.concat(e.files)}))}}()
if("object"===("undefined"==typeof r?"undefined":o(r)))return r.v
case d["default"].REMOVE_FILES:return n="undefined"==typeof t.payload.ids?(0,a["default"])(l({},e,{count:0,files:[]})):(0,a["default"])(l({},e,{count:e.files.filter(function(e){return t.payload.ids.indexOf(e.id)===-1
...
if(i){var s=function(){var n=l({},i,t.payload.file)
return{v:(0,a["default"])(l({},e,{files:e.files.map(function(e){return e.id===n.id?n:e})}))}}()
if("object"===("undefined"==typeof s?"undefined":o(s)))return s.v}else if(e.folder.id===t.payload.id)return(0,a["default"])(l({},e,{folder:l({},e.folder,t.payload.file)}))
return e
case d["default"].UNLOAD_FOLDER:return l({},e,{files:[]})
case d["default"].SELECT_FILES:var u=null
return u=null===t.payload.ids?e.files.map(function(e){return e.id}):e.selectedFiles.concat(t.payload.ids.filter(function(t){return e.selectedFiles.indexOf(t)===-1})),(0,a["default"])(l({},e,{selectedFiles:u
}))
case d["default"].DESELECT_FILES:var c=null
return c=null===t.payload.ids?[]:e.selectedFiles.filter(function(e){return t.payload.ids.indexOf(e)===-1}),(0,a["default"])(l({},e,{selectedFiles:c}))
case d["default"].DELETE_ITEM_SUCCESS:return(0,a["default"])(l({},e,{selectedFiles:e.selectedFiles.filter(function(e){return t.payload.ids.indexOf(e)===-1}),files:e.files.filter(function(e){return t.payload.ids.indexOf(e.id)===-1
...
return(0,a["default"])(l({},e,{files:f.sort(t.payload.comparator).concat(h.sort(t.payload.comparator))}))
case d["default"].LOAD_FOLDER_REQUEST:return(0,a["default"])(l({},e,{errorMessage:null,folderId:t.payload.folderId,selectedFiles:[],files:[],count:0,loading:!0}))
case d["default"].LOAD_FOLDER_SUCCESS:return(0,a["default"])(l({},e,{folder:t.payload.folder,files:t.payload.files,count:t.payload.files.length,loading:!1}))
case d["default"].LOAD_FOLDER_FAILURE:return(0,a["default"])(l({},e,{errorMessage:t.payload.message,loading:!1}))
...
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}
t["default"]=i
var s=n(37),a=r(s),u=n(11),d=r(u),p={count:0,editorFields:[],file:null,files:[],fileId:0,folderId:0,focus:!1,path:null,selectedFiles:[],page:0,errorMessage:null}},function(e,t){e.exports=DeepFreezeStrict

},function(e,t,n){"use strict"
function r(e){return e&&e.__esModule?e:{"default":e}}function i(){return(0,a["default"])({attributes:{dimensions:{height:null,width:null}},name:null,canDelete:!1,canEdit:!1,category:null,created:null,extension:null,
...
switch(t.type){case d["default"].ADD_QUEUED_FILE:return(0,a["default"])(l({},e,{items:e.items.concat([l({},i(),t.payload.file)])}))
case d["default"].FAIL_UPLOAD:return(0,a["default"])(l({},e,{items:e.items.map(function(e){return e.queuedAtTime===t.payload.queuedAtTime?l({},e,{message:t.payload.message}):e})}))
case d["default"].PURGE_UPLOAD_QUEUE:return(0,a["default"])(l({},e,{items:e.items.filter(function(e){return!e.message||"error"!==e.message.type&&"success"!==e.message.type})}))
case d["default"].REMOVE_QUEUED_FILE:return(0,a["default"])(l({},e,{items:e.items.filter(function(e){return e.queuedAtTime!==t.payload.queuedAtTime})}))
case d["default"].SUCCEED_UPLOAD:return(0,a["default"])(l({},e,{items:e.items.map(function(e){return e.queuedAtTime===t.payload.queuedAtTime?l({},e,{messages:[{value:c["default"]._t("AssetAdmin.DROPZONE_SUCCESS_UPLOAD"),
type:"success",extraClass:"success"}]}):e})}))
case d["default"].UPDATE_QUEUED_FILE:return(0,a["default"])(l({},e,{items:e.items.map(function(e){return e.queuedAtTime===t.payload.queuedAtTime?l({},e,t.payload.updates):e})}))
default:return e}}Object.defineProperty(t,"__esModule",{value:!0})
var l=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},s=n(37),a=r(s),u=n(28),d=r(u),p=n(9),c=r(p),f={items:[]}
t["default"]=o},function(e,t,n){"use strict"
function r(e){return e&&e.__esModule?e:{"default":e}}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function o(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called")


return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function l(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function s(e){var t=e.config.sections[y]
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),d=n(3),p=r(d),c=n(5),f=n(40),h=n(6),m=r(h),y="SilverStripe\\AssetAdmin\\Controller\\AssetAdmin",g=function(e){
function t(e){i(this,t)
var n=o(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
query:this.props.location.query,getUrl:this.getUrl,onBrowse:this.handleBrowse}}},{key:"handleBrowse",value:function s(e,t,n){var r=this.getUrl(e,t),i=null
i=null===n||n?a({},this.props.location.query,n):this.props.location.query,this.props.router.push(a({},this.props.location,{pathname:r,query:i}))}},{key:"render",value:function d(){if(!this.props.sectionConfig)return null
...
fileId:d.PropTypes.string,folderId:d.PropTypes.string}),router:d.PropTypes.object},t.AssetAdminRouter=g,t["default"]=(0,f.withRouter)((0,c.connect)(s)(g))},function(e,t){e.exports=ReactRouter},function(e,t){}])
