...
multiline:!0}),v["default"].createElement("div",{className:"asset-admin__toolbar-extra pull-xs-right"},v["default"].createElement(Q["default"],{onSearch:this.handleDoSearch,id:"AssetSearchForm",searchFormSchemaUrl:t,
folderId:this.props.folderId,filters:n}),this.props.toolbarChildren)),v["default"].createElement("div",{className:"flexbox-area-grow fill-width fill-height gallery"},this.renderGallery(),this.renderEditor()),"admin"!==this.props.type&&this.props.loading&&[v["default"].createElement("div",{
