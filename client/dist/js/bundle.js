...
return n.handleSubmit=n.handleSubmit.bind(n),n.handleBrowse=n.handleBrowse.bind(n),n.getUrl=n.getUrl.bind(n),n.state={folderId:0,fileId:e.fileAttributes.ID,query:{}},n}return l(t,e),d(t,[{key:"componentWillMount",
...
e&&e.schemaUrl){var t=c({},e.fileAttributes)
delete t.ID
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),d=n(3),f=o(d),h=n(5),m=n(4),g=n(7),y=o(g),v=n(8),b=o(v),C=n(9),E=o(C),S=n(10),_=r(S),w=n(12),x=r(w),P=n(13),F=o(P),T=n(17),O=o(T),I=n(274),A=o(I),D=n(275),k=o(D),N=function(e){
function t(e){i(this,t)
var n=s(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
n.handleBrowse=n.handleBrowse.bind(n),n.handleViewChange=n.handleViewChange.bind(n),n.compare=n.compare.bind(n),n}return l(t,e),c(t,[{key:"componentWillMount",value:function n(){var e=this.props.sectionConfig
...
parentID:d.PropTypes.number,canView:d.PropTypes.bool,canEdit:d.PropTypes.bool})},N.defaultProps={type:"admin"},t.AssetAdmin=N,t["default"]=(0,h.connect)(a,u)(N)},function(e,t){e.exports=SilverStripeComponent
...
}}),e})}}Object.defineProperty(t,"__esModule",{value:!0}),t.addFiles=o,t.deleteItems=i,t.loadFolderContents=s,t.unloadFolderContents=l,t.loadFile=a,t.selectFiles=u,t.deselectFiles=p,t.createFolder=c
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),a=n(9),u=r(a),p=n(3),c=r(p),d=n(14),f=r(d),h=n(15),m=r(h),g=n(16),y=r(g),v=function(e){
...
n.handleCreateFolder=n.handleCreateFolder.bind(n),n.handleViewChange=n.handleViewChange.bind(n),n.renderNoItemsNotice=n.renderNoItemsNotice.bind(n),n}return a(t,e),d(t,[{key:"componentDidMount",value:function n(){
...
e.props.actions.gallery.deleteItems(e.props.deleteApi,n)},n=function s(t){e.props.onOpenFile(t[0].id)},r=L["default"].BULK_ACTIONS.map(function(e){return"delete"!==e.value||e.callback?"edit"!==e.value||e.callback?e:c({},e,{
...
return c({},t,{selected:e.itemIsSelected(t.id),highlighted:e.itemIsHighlighted(t.id)})}),r=this.props.queuedFiles.items.map(function(e){return c({},e,{uploading:!0})}),o=[].concat(i(r),i(n)),s=this.props,l=s.type,a=s.loading,u=s.page,p=s.count,d=s.limit,f=s.sort,h={
selectableItems:"admin"===l,files:o,loading:a,page:u,count:p,limit:d,sort:f,onSort:this.handleSort,onSetPage:this.handleSetPage,onOpenFile:this.handleOpenFile,onOpenFolder:this.handleOpenFolder,onSelect:this.handleSelect,
...
G.defaultProps=c({},z,{type:"admin",view:"tile"}),G.propTypes=c({},q,{type:y.PropTypes.oneOf(["insert","admin"]),view:y.PropTypes.oneOf(["tile","table"]),dialog:y.PropTypes.bool,fileId:y.PropTypes.number,
...
},w.defaultProps={uploadButton:!0},t["default"]=w},function(e,t,n){(function(e,t){(function(){var n,r,o,i,s,l,a,u,p=[].slice,c={}.hasOwnProperty,d=function(e,t){function n(){this.constructor=e}for(var r in t)c.call(t,r)&&(e[r]=t[r])
...
},addedfile:function(e){var n,r,o,i,s,l,a,u,p,c,d,f,h
...
this.previewsContainer.appendChild(e.previewElement),c=e.previewElement.querySelectorAll("[data-dz-name]"),i=0,a=c.length;i<a;i++)n=c[i],n.textContent=this._renameFilename(e.name)
...
return o=document.createElement("img"),r&&(o.crossOrigin=r),o.onload=function(t){return function(){var r,i,s,a,u,p,c,d
...
r.width=s.trgWidth,r.height=s.trgHeight,l(i,o,null!=(u=s.srcX)?u:0,null!=(p=s.srcY)?p:0,s.srcWidth,s.srcHeight,null!=(c=s.trgX)?c:0,null!=(d=s.trgY)?d:0,s.trgWidth,s.trgHeight),a=r.toDataURL("image/png"),
...
var r,i,s,l,a,u,p,c,d,f,h,m,g,y,v,b,C,E,S,_,w,x,P,F,T,O,I,A,D,k,N,R,L,U
...
return i}}(this),b=function(t){return function(n){var o,i,s,l,a,u,p,c,d
...
if(o)return}for(d=[],a=0,c=e.length;a<c;a++)r=e[a],d.push(t.emit("uploadprogress",r,i,r.upload.bytesSent))
...
d=c.getAttribute("name"),f=c.getAttribute("type"),"SELECT"===c.tagName&&c.hasAttribute("multiple"))for(R=c.options,P=0,I=R.length;P<I;P++)g=R[P],g.selected&&i.append(d,g.value)
else(!f||"checkbox"!==(L=f.toLowerCase())&&"radio"!==L||c.checked)&&i.append(d,c.value)
...
a=i+p>>1
return u=a/s,0===u?1:u},l=function(e,t,n,r,o,i,l,a,u,p){var c
return c=s(t),e.drawImage(t,n,r,o,i,l,a,u,p/c)},i=function(e,t){var n,r,o,i,s,l,a,u,p
...
try{u.doScroll("left")}catch(t){return e=t,void setTimeout(s,50)}return i("poll")},"complete"!==r.readyState){if(r.createEventObject&&u.doScroll){try{p=!e.frameElement}catch(c){}p&&s()}return r[n](l+"DOMContentLoaded",i,!1),
...
}),this.props.selectableItems&&l(n,{selectable:!0,onSelect:this.props.onSelect}),d["default"].createElement(h["default"],n)}},{key:"render",value:function v(){return d["default"].createElement("div",{className:"gallery__main-view--tile"
...
value:!0})
var l=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n]
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),a=n(9),u=r(a),p=n(3),c=r(p),d=n(14),f=r(d),h=n(7),m=r(h),g=n(29),y=r(g),v=function(e){
function t(e){o(this,t)
var n=i(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
var r=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},o=n(3),i=n(31),s=n(198),l=n(199),a=n(200),u=n(206),p=n(207),c=n(189),d=n(224),f=n(225),h=n(226),m=n(33),g=n(196),y=n(208),v=n(227),b=n(229),C=n(152),E=n(230),S=n(209),_=n(231),w=n(232),x=n(102),P=n(235),F=n(236),T=n(237),O=n(238),I=n(34),A=n(184),D=n(149),k=n(270),N=n(140),R=n(125),L=o.createClass({
...
a.columns.forEach(function(e,t){u.push(N(e)),"asc"===a.orders[t]||"desc"===a.orders[t]?p.push(a.orders[t]):p.push(r.state.sortDirection)}),e=k(e,u,p)}}var c=this.getCurrentPage()
...
var c=this.getCurrentPage(),d=this.getCurrentMaxPage(),f=c+1<d,h=this.getPagingSection(c,d),m=this.getContentSection(u,a,p,h,f,this.props.globalData),g=this.getColumnSelectorSection(l,a),v=this.props.gridClassName.length>0?"griddle "+this.props.gridClassName:"griddle"
...
c.Griddle=e.exports=L},function(e,t,n){"use strict"
...
if(this.props.enableInfiniteScroll&&null!==this.props.rowHeight&&void 0!==this.refs.scrollable){var a=e.getAdjustedRowHeight(),u=Math.ceil(e.state.clientHeight/a),p=Math.max(0,Math.floor(e.state.scrollTop/a)-.25*u),c=Math.min(p+1.25*u,this.props.data.length-1)


n=n.slice(p,c+1)
var d={height:p*a+"px"}
o=r.createElement("tr",{key:"above-"+d.height,style:d})
var f={height:(this.props.data.length-c)*a+"px"}
...
l=r.createElement("tbody",null,r.createElement("tr",null,r.createElement("td",{style:u,colSpan:p},c)))}var d=this.props.showTableHeading?r.createElement(o,{useGriddleStyles:this.props.useGriddleStyles,
...
className:this.props.className,style:this.props.useGriddleStyles&&a||null},d),r.createElement("div",{ref:"scrollable",onScroll:this.gridScroll,style:s},r.createElement("table",{className:this.props.className,
...
var e=this,t={},n=this.props.columnSettings.getColumns().map(function(n,i){var a={},u="",p=e.props.columnSettings.getMetadataColumnProperty(n,"sortable",!0),c=p?e.props.sortSettings.sortDefaultComponent:null
...
var d=e.props.columnSettings.getColumnMetadataByName(n),f=e.props.columnSettings.getMetadataColumnProperty(n,"displayName",n),h=e.props.columnSettings.getMetadataColumnProperty(n,"customHeaderComponent",l),m=e.props.columnSettings.getMetadataColumnProperty(n,"customHeaderComponentProps",{})


u=null==d?u:(u&&u+" "||u)+e.props.columnSettings.getMetadataColumnProperty(n,"cssClassName",""),e.props.useGriddleStyles&&(a={backgroundColor:"#EDEDEF",border:"0px",borderBottom:"1px solid #DDD",color:"#222",
padding:"5px",cursor:p?"pointer":"default"}),t=d&&d.titleStyles?s({},a,d.titleStyles):s({},a)
var g=f?"th":"td"
...
value:function p(e){return l(this.columnMetadata,{columnName:e})}},{key:"hasColumnMetadata",value:function c(){return null!==this.columnMetadata&&this.columnMetadata.length>0}},{key:"getMetadataColumnProperty",
...
if(p&&c[2]?c[1]!==e[c[0]]:!(c[0]in e))return!1}for(;++a<u;){c=n[a]
...
var t=o(e)?h:u
return t.test(l(e))}var o=n(56),i=n(64),s=n(63),l=n(66),a=/[\\^$.*+?()[\]{}|]/g,u=/^\[object .+?Constructor\]$/,p=Function.prototype,c=Object.prototype,d=p.toString,f=c.hasOwnProperty,h=RegExp("^"+d.call(f).replace(a,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$")
...
return v||(v=new o),g(T,O,n,r,v)}}return!!x&&(v||(v=new o),l(e,t,n,r,g,v))}var o=n(39),i=n(85),s=n(91),l=n(95),a=n(116),u=n(102),p=n(103),c=n(106),d=1,f="[object Arguments]",h="[object Array]",m="[object Object]",g=Object.prototype,y=g.hasOwnProperty


e.exports=r},function(e,t,n){function r(e,t,n,r,u,p){var c=n&l,d=e.length,f=t.length
...
return x["delete"](e),O
case C:if(w)return w.call(e)==w.call(t)}return!1}var o=n(58),i=n(92),s=n(44),l=n(85),a=n(93),u=n(94),p=1,c=2,d="[object Boolean]",f="[object Date]",h="[object Error]",m="[object Map]",g="[object Number]",y="[object RegExp]",v="[object Set]",b="[object String]",C="[object Symbol]",E="[object ArrayBuffer]",S="[object DataView]",_=o?o.prototype:void 0,w=_?_.valueOf:void 0
...
return e.forEach(function(e){n[++t]=e}),n}e.exports=n},function(e,t,n){function r(e,t,n,r,s,a){var u=n&i,p=o(e),c=p.length,d=o(t),f=d.length
if(c!=f&&!u)return!1
...
e.exports=r},function(e,t,n){function r(e,t){var n=s(e),r=!n&&i(e),p=!n&&!r&&l(e),d=!n&&!r&&!p&&u(e),f=n||r||p||d,h=f?o(e.length,String):[],m=h.length
for(var g in e)!t&&!c.call(e,g)||f&&("length"==g||p&&("offset"==g||"parent"==g)||d&&("buffer"==g||"byteLength"==g||"byteOffset"==g)||a(g,m))||h.push(g)
return h}var o=n(98),i=n(99),s=n(102),l=n(103),a=n(105),u=n(106),p=Object.prototype,c=p.hasOwnProperty
...
e.exports=l},function(e,t,n){function r(e){return s(e)&&i(e.length)&&!!A[o(e)]}var o=n(57),i=n(108),s=n(101),l="[object Arguments]",a="[object Array]",u="[object Boolean]",p="[object Date]",c="[object Error]",d="[object Function]",f="[object Map]",h="[object Number]",m="[object Object]",g="[object RegExp]",y="[object Set]",v="[object String]",b="[object WeakMap]",C="[object ArrayBuffer]",E="[object DataView]",S="[object Float32Array]",_="[object Float64Array]",w="[object Int8Array]",x="[object Int16Array]",P="[object Int32Array]",F="[object Uint8Array]",T="[object Uint8ClampedArray]",O="[object Uint16Array]",I="[object Uint32Array]",A={}


A[S]=A[_]=A[w]=A[x]=A[P]=A[F]=A[T]=A[O]=A[I]=!0,A[l]=A[a]=A[C]=A[u]=A[E]=A[p]=A[c]=A[d]=A[f]=A[h]=A[m]=A[g]=A[y]=A[v]=A[b]=!1,e.exports=r},function(e,t){function n(e){return"number"==typeof e&&e>-1&&e%1==0&&e<=r
...
e.exports=r},function(e,t,n){var r=n(117),o=n(53),i=n(118),s=n(119),l=n(120),a=n(57),u=n(66),p="[object Map]",c="[object Object]",d="[object Promise]",f="[object Set]",h="[object WeakMap]",m="[object DataView]",g=u(r),y=u(o),v=u(i),b=u(s),C=u(l),E=a

;(r&&E(new r(new ArrayBuffer(1)))!=m||o&&E(new o)!=p||i&&E(i.resolve())!=d||s&&E(new s)!=f||l&&E(new l)!=h)&&(E=function(e){var t=a(e),n=t==c?e.constructor:void 0,r=n?u(n):""
...
var r=i(n,e)
return void 0===r&&r===t?s(n,e):o(t,r,c|d)}}var o=n(83),i=n(125),s=n(136),l=n(128),a=n(122),u=n(123),p=n(135),c=1,d=2
...
e=e[d]}return c||++r!=p?c:(p=null==e?0:e.length,!!p&&a(p)&&l(d,p)&&(s(e)||i(e)))}var o=n(127),i=n(99),s=n(102),l=n(105),a=n(108),u=n(135)
...
e=e.replace(l,"")
var n=u.test(e)
return n||p.test(e)?c(e.slice(2),n?2:8):a.test(e)?s:+e}var o=n(63),i=n(129),s=NaN,l=/^\s+|\s+$/g,a=/^[-+]0x[0-9a-f]+$/i,u=/^0b[01]+$/i,p=/^0o[0-7]+$/i,c=parseInt
...
return l(c,function(e,t){return u(e,t,n)})}var o=n(35),i=n(36),s=n(143),l=n(164),a=n(109),u=n(165),p=n(139)
...
e.exports=l},function(e,t,n){function r(e,t,n,r){var c=-1,d=i,f=!0,h=e.length,m=[],g=t.length
if(!h)return m
n&&(t=l(t,a(n))),r?(d=s,f=!1):t.length>=p&&(d=u,f=!1,t=new o(t))
e:for(;++c<h;){var y=e[c],v=null==n?y:n(y)
if(y=r||0!==y?y:0,f&&v===v){for(var b=g;b--;)if(t[b]===v)continue e
m.push(y)}else d(t,v,r)||m.push(y)}return m}var o=n(86),i=n(178),s=n(182),l=n(35),a=n(109),u=n(90),p=200
...
e.exports=r},function(e,t,n){var r=n(185),o=n(187),i=n(188),s=n(115),l=n(112),a=n(96),u=Object.prototype,p=u.hasOwnProperty,c=i(function(e,t){if(l(t)||s(t))return void o(t,a(t),e)
...
t=i(t,e)
for(var u=-1,p=t.length,c=p-1,d=e;null!=d&&++u<p;){var f=a(t[u]),h=n
if(u!=c){var m=d[f]
h=r?r(m,f,d):void 0,void 0===h&&(h=l(m)?m:s(t[u+1])?[]:{})}o(d,f,h),d=d[f]}return e}var o=n(185),i=n(127),s=n(105),l=n(63),a=n(135)
...
e.exports=o},function(e,t,n){"use strict"
var r=n(3),o=n(33),i=n(208),s=n(56),l=n(212),a=n(184),u=n(214),p=n(220),c=n(205),d=r.createClass({displayName:"GridRow",getDefaultProps:function f(){return{isChildRow:!1,showChildren:!1,data:{},columnSettings:null,
...
var o=this.props.columnSettings.getColumns(),d=l(o,[]),f=a({},this.props.data)
u(f,d)
var h=p(i.pick(f,c(o,"children"))),m=h.map(function(t,o){var i=null,s=e.props.columnSettings.getColumnMetadataByName(t[0]),l=0===o&&e.props.hasChildren&&e.props.showChildren===!1&&e.props.useGriddleIcons?r.createElement("span",{
...
e.exports=l},function(e,t,n){function r(e,t,n){for(var r=n?s:i,c=e[0].length,d=e.length,f=d,h=Array(d),m=1/0,g=[];f--;){var y=e[f]
f&&t&&(y=l(y,a(t))),m=p(y.length,m),h[f]=!n&&(t||c>=120&&y.length>=120)?new o(f&&y):void 0}y=e[0]
var v=-1,b=h[0]
...
if(a(e)&&(l(e)||"string"==typeof e||"function"==typeof e.splice||u(e)||c(e)||s(e)))return!e.length
var t=i(e)
if(t==d||t==f)return!e.size
if(p(e))return!o(e).length
for(var n in e)if(m.call(e,n))return!1
return!0}var o=n(111),i=n(116),s=n(99),l=n(102),a=n(115),u=n(103),p=n(112),c=n(106),d="[object Map]",f="[object Set]",h=Object.prototype,m=h.hasOwnProperty
e.exports=r},function(e,t){function n(e){return null===e}e.exports=n},function(e,t){function n(e){return void 0===e}e.exports=n},function(e,t,n){var r=n(35),o=n(239),i=n(267),s=n(127),l=n(187),a=n(194),u=n(252),p=1,c=2,d=4,f=a(function(e,t){
var n={}
if(null==e)return n
var a=!1
t=r(t,function(t){return t=s(t,e),a||(a=t.length>1),t}),l(e,u(e),n),a&&(n=o(n,p|c|d))
...
function t(e){o(this,t)
var n=i(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
return n.getColumns=n.getColumns.bind(n),n.handleSort=n.handleSort.bind(n),n.handleSetPage=n.handleSetPage.bind(n),n.handleRowClick=n.handleRowClick.bind(n),n.renderSelect=n.renderSelect.bind(n),n.state={
enableSort:!1},n}return s(t,e),a(t,[{key:"componentDidMount",value:function n(){this.setState({enableSort:!0})}},{key:"componentWillUnmount",value:function r(){this.setState({enableSort:!1})}},{key:"getColumns",
value:function u(){var e=["thumbnail","title","size","lastUpdated"]
...
return 0}},{columnName:"lastUpdated",displayName:"Modified",customComponent:this.renderDate},{columnName:"size",displayName:"Size",customComponent:this.renderSize}]}},{key:"getTableProps",value:function f(){
var e=this.props.sort.split(","),t=l(e,2),n=t[0],r=t[1]
...
return p["default"].createElement("span",null,t)}},{key:"renderSelect",value:function S(e){return p["default"].createElement("input",{type:"checkbox",title:h["default"]._t("AssetAdmin.SELECT"),checked:e.data,
tabIndex:"-1",onMouseDown:this.preventFocus})}},{key:"renderDate",value:function _(e){return"folder"===e.rowData.type?null:p["default"].createElement("span",null,e.data)}},{key:"renderThumbnail",value:function w(e){
var t=e.data||e.rowData.url
return t?p["default"].createElement("img",{src:t,alt:e.rowData.title,className:"gallery__table-image"}):p["default"].createElement("div",{className:"gallery__table-image--error"})}},{key:"render",value:function x(){
...
})}}function l(e){return function(t){return t({type:c["default"].REMOVE_QUEUED_FILE,payload:{queuedId:e}})}}function a(e){return function(t){return t({type:c["default"].SUCCEED_UPLOAD,payload:{queuedId:e
...
function r(e){return e&&e.__esModule?e:{"default":e}}var o=n(4),i=n(278),s=r(i),l=n(279),a=r(l),u=n(280),p=r(u),c=n(281),d=r(c),f=n(283),h=r(f),m=n(285),g=r(m),y=n(287),v=r(y),b=n(289),C=r(b),E=n(290),S=r(E),_=n(295),w=r(_)
...
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e}
t["default"]=o
var l=n(282),a=r(l),u=n(11),p=r(u),c={count:0,editorFields:[],file:null,files:[],fileId:0,folderId:0,focus:!1,path:null,selectedFiles:[],page:0,errorMessage:null}},function(e,t){e.exports=DeepFreezeStrict
...
switch(t.type){case u["default"].ADD_QUEUED_FILE:return(0,l["default"])(i({},e,{items:e.items.concat([i({},c["default"],t.payload.file)])}))
...
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},s=n(282),l=r(s),a=n(273),u=r(a),p=n(284),c=r(p),d=n(9),f=r(d),h={items:[]}
...
fileId:u.PropTypes.string,folderId:u.PropTypes.string}),router:u.PropTypes.object},t.AssetAdminRouter=y,t["default"]=(0,d.withRouter)((0,c.connect)(l)(y))},function(e,t){e.exports=ReactRouter},function(e,t,n){
"use strict"
...
switch(t.type){case c["default"].UPLOADFIELD_ADD_FILE:return n(function(e){return{files:[].concat(o(e.files),[l({},f["default"],t.payload.file)])}})
case c["default"].UPLOADFIELD_SET_FILES:return n(function(){return{files:t.payload.files}})
case c["default"].UPLOADFIELD_UPLOAD_FAILURE:return n(function(e){return{files:e.files.map(function(e){return e.queuedId===t.payload.queuedId?l({},e,{message:t.payload.message}):e})}})
...
case c["default"].UPLOADFIELD_UPLOAD_SUCCESS:return n(function(e){return{files:e.files.map(function(e){return e.queuedId===t.payload.queuedId?l({},e,t.payload.json):e})}})
case c["default"].UPLOADFIELD_UPDATE_QUEUED_FILE:return n(function(e){return{files:e.files.map(function(e){return e.queuedId===t.payload.queuedId?l({},e,t.payload.updates):e})}})
default:return e}}Object.defineProperty(t,"__esModule",{value:!0})
var l=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},a=n(282),u=r(a),p=n(288),c=r(p),d=n(284),f=r(d),h={fields:{}},m={files:[]}
...
var p=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},c=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n]
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),d=n(9),f=o(d),h=n(3),m=o(h),g=n(5),y=n(4),v=n(14),b=o(v),C=n(7),E=o(C),S=n(291),_=o(S),w=n(292),x=o(w),P=n(22),F=o(P),T=n(293),O=o(T),I=n(29),A=o(I),D=n(294),k=r(D),N=function(e){
function t(e){i(this,t)
var n=s(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
n.handleItemRemove=n.handleItemRemove.bind(n),n.handleChange=n.handleChange.bind(n),n.state={selecting:!1},n}return l(t,e),c(t,[{key:"componentDidMount",value:function n(){this.props.actions.uploadField.setFiles(this.props.id,this.props.data.files)
...
value:!0})
var l=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n]
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),a=n(9),u=r(a),p=n(3),c=r(p),d=n(7),f=r(d),h=n(14),m=r(h),g=n(29),y=r(g),v=function(e){
function t(e){o(this,t)
var n=i(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
return"string"==typeof n&&(o={value:n,type:"error"}),r({type:c["default"].UPLOADFIELD_UPLOAD_FAILURE,payload:{fieldId:e,queuedId:t,message:o}})}}function l(e,t){return function(n){return n({type:c["default"].UPLOADFIELD_REMOVE_FILE,
payload:{fieldId:e,file:t}})}}function a(e,t,n){return function(r){return r({type:c["default"].UPLOADFIELD_UPLOAD_SUCCESS,payload:{fieldId:e,queuedId:t,json:n}})}}function u(e,t,n){return function(r){return r({
type:c["default"].UPLOADFIELD_UPDATE_QUEUED_FILE,payload:{fieldId:e,queuedId:t,updates:n}})}}Object.defineProperty(t,"__esModule",{value:!0}),t.addFile=o,t.setFiles=i,t.failUpload=s,t.removeFile=l,t.succeedUpload=a,
...
className:t},c["default"].createElement("ul",{className:"list-group list-group-flush file-history__list"},this.state.history.map(function(t){return c["default"].createElement(v["default"],a({key:t.versionid
},t,{onClick:e.handleClick}))})))}}]),t}(p.Component)
E.propTypes={historySchemaUrl:c["default"].PropTypes.string,data:c["default"].PropTypes.object},E.defaultProps={data:{fieldId:0}},t.HistoryList=E,t["default"]=(0,d.connect)(l)(E)},function(e,t,n){"use strict"
...
value:!0})
var l=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n]
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),a=n(3),u=r(a),p=n(7),c=r(p),d=function(e){
function t(e){o(this,t)
var n=i(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e))
...
d.propTypes={versionid:a.PropTypes.number.isRequired,summary:a.PropTypes.oneOfType([a.PropTypes.bool,a.PropTypes.string]).isRequired,status:a.PropTypes.string,author:a.PropTypes.string,date:a.PropTypes.string,
onClick:a.PropTypes.func},t["default"]=d},function(e,t){}])
