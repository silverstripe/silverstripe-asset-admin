...
return i({},t,a({},r,o))},{})},r=/\[embed(.*?)](.+?)\[\/\s*embed\s*]/gi,o=r.exec(e);o;){var d=n(o[1]),s=(0,l.default)("<div/>").attr("data-url",d.url||o[2]).attr("data-shortcode","embed").addClass(d.class).addClass("ss-htmleditorfield-file embed"),c=(0,
l.default)("<img />").attr("src",d.thumbnail).addClass("placeholder")
if(d.width&&d.height&&(s.width(d.width),s.height(d.height),c.attr("width",d.width),c.attr("height",d.height)),s.append(c),d.caption){var u=(0,l.default)("<p />").addClass("caption").text(d.caption)
s.append(u)}e=e.replace(o[0],s.html()),o=r.exec(e)}t.content=e})}}
...
return n.close()},a=function t(){return n._handleInsert.apply(n,arguments)},i=function t(){return n._handleCreate.apply(n,arguments)},o=function t(){return n._handleLoadingError.apply(n,arguments)},d=window.ss.store,l=window.ss.apolloClient,s=this.getOriginalAttributes(),u=window.InsertEmbedModal.default


if(!u)throw new Error("Invalid Insert embed modal component found")
h.default.render(c.default.createElement(f.ApolloProvider,{store:d,client:l},c.default.createElement(u,{show:e,onCreate:i,onInsert:a,onHide:r,onLoadingError:o,bodyClassName:"modal__dialog",className:"insert-embed-react__dialog-wrapper",
...
var i=a.closest("[data-shortcode='embed']")
...
if(a.Width&&a.Height&&(i.width(a.Width),i.height(a.Height),o.attr("width",a.Width),o.attr("height",a.Height)),i.append(o),a.CaptionText){var d=(0,l.default)("<p />").addClass("caption").text(a.CaptionText)


i.append(d)}var s=t(r.getSelectedNode()),c=t(null)
return s.length&&(c=s.closest("[data-shortcode='embed']"),0===c.length&&(c=s.closest("img")),0===c.length&&(c=s)),c.length?c.replaceWith(i):(r.repaint(),r.insertContent(t("<div />").append(i.clone()).html(),{
