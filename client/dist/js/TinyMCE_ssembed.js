...
"mceAdvMedia"!==n&&"mceAdvMedia"!==n||(t.preventDefault(),e.execCommand("ssembed",r,a))}),e.on("SaveContent",function(t){var e=(0,l.default)("<div>"+t.content+"</div>"),n=function t(e){return Object.entries(e).map(function(t){
var e=o(t,2),n=e[0],r=e[1]
return r?n+'="'+r+'"':null}).filter(function(t){return null!==t}).join(" ")}
e.find(p).each(function t(){var e=(0,l.default)(this),r=e.find("img.placeholder")
if(0===r.length)return e.removeAttr("data-url"),void e.removeAttr("data-shortcode")
var a=e.find(".caption").text(),i=parseInt(r.attr("width"),10),o=parseInt(r.attr("height"),10),d=e.data("url"),s={url:d,thumbnail:r.prop("src"),class:e.prop("class"),width:isNaN(i)?null:i,height:isNaN(o)?null:o,
caption:a},u="[embed "+n(s)+"]"+d+"[/embed]"
e.replaceWith(u)}),t.content=e.html()}),e.on("BeforeSetContent",function(t){for(var e=t.content,n=function t(e){return e.match(/([^\s\/'"=,]+)\s*=\s*(('([^']+)')|("([^"]+)")|([^\s,\]]+))/g).reduce(function(t,e){
...
s.append(c)}e=e.replace(o[0],(0,l.default)("<div/>").append(s).html()),o=r.exec(e)}t.content=e})}}
...
var o=i.find("img.placeholder")
if(0===o.length)return n
var d=i.find(".caption").text(),l=parseInt(o.width(),10),s=parseInt(o.height(),10)
