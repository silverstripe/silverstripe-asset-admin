...
if (typeof(ss) === 'undefined' || typeof(ss.i18n) === 'undefined') {
  ...
  ss.i18n.addDictionary('sl', {
    ...
    "AssetAdmin.BULK_ACTIONS_DELETE_FAIL": "%s folders/files were successfully deleted, but %s files were not able to be deleted.",
    ...
    "AssetAdmin.BULK_ACTIONS_DELETE_SINGLE_CONFIRM": "This file is currently used in %s place(s), are you sure you want to delete it?",
    "AssetAdmin.BULK_ACTIONS_DELETE_SUCCESS": "%s folders/files were successfully deleted.",
