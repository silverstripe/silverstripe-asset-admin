...
if (typeof(ss) === 'undefined' || typeof(ss.i18n) === 'undefined') {
  ...
  ss.i18n.addDictionary('en', {
    ...
    "AssetAdmin.CATEGORY_ARCHIVE": "archive",
    "AssetAdmin.CATEGORY_AUDIO": "audio",
    "AssetAdmin.CATEGORY_DOCUMENT": "document",
    "AssetAdmin.CATEGORY_FOLDER": "folder",
    "AssetAdmin.CATEGORY_IMAGE": "image",
    "AssetAdmin.CATEGORY_VIDEO": "video",
    ...
    "AssetAdmin.FILE_GALLERY": "File gallery",
    "AssetAdmin.FILE_MISSING": "File cannot be found",
    "AssetAdmin.FILE_TITLE": "Title: {title}",
    ...
    "AssetAdmin.IMAGE_EDITOR_APPLY": "Apply",
    "AssetAdmin.IMAGE_EDITOR_ASPECT": "Aspect ratio",
    "AssetAdmin.IMAGE_EDITOR_ASPECT_FREE": "Freeform",
    "AssetAdmin.IMAGE_EDITOR_ASPECT_ORIGINAL": "Original",
    "AssetAdmin.IMAGE_EDITOR_BACKUP_LABEL": "Back up the original image",
    "AssetAdmin.IMAGE_EDITOR_CANCEL": "Cancel",
    "AssetAdmin.IMAGE_EDITOR_CROP": "Crop",
    "AssetAdmin.IMAGE_EDITOR_CROPPED_DIMENSIONS": "Cropped: %s x %s",
    "AssetAdmin.IMAGE_EDITOR_CROP_OFF": "Crop tool off",
    "AssetAdmin.IMAGE_EDITOR_CROP_ON": "Crop tool on",
    "AssetAdmin.IMAGE_EDITOR_FAILED": "The image could not be edited. Please try again.",
    "AssetAdmin.IMAGE_EDITOR_FLIPPED_HORIZ": "Flipped horizontally",
    "AssetAdmin.IMAGE_EDITOR_FLIPPED_VERT": "Flipped vertically",
    "AssetAdmin.IMAGE_EDITOR_FLIP_HORIZ": "Flip horizontal",
    "AssetAdmin.IMAGE_EDITOR_FLIP_VERT": "Flip vertical",
    "AssetAdmin.IMAGE_EDITOR_ORIGINAL_DIMENSIONS": "Original: %s x %s",
    "AssetAdmin.IMAGE_EDITOR_ORIGINAL_SIZE": "File size: %s",
    "AssetAdmin.IMAGE_EDITOR_OUTPUT_DIMENSIONS": "Output: %s x %s",
    "AssetAdmin.IMAGE_EDITOR_PUBLISH_REQUIRED": "The edited image will be saved as draft, publish the image to update it on the live site",
    "AssetAdmin.IMAGE_EDITOR_RESET": "Reset all changes",
    "AssetAdmin.IMAGE_EDITOR_RESET_BUTTON": "Reset",
    "AssetAdmin.IMAGE_EDITOR_RESIZE_HEIGHT": "Height",
    "AssetAdmin.IMAGE_EDITOR_RESIZE_INVALID": "Enter a whole number of pixels, 1 or more",
    "AssetAdmin.IMAGE_EDITOR_RESIZE_TOO_LARGE": "Cannot be larger than the cropped image (%s x %s)",
    "AssetAdmin.IMAGE_EDITOR_RESIZE_TOO_LARGE_ORIGINAL": "Cannot be larger than the original image (%s x %s)",
    "AssetAdmin.IMAGE_EDITOR_RESIZE_WIDTH": "Width",
    "AssetAdmin.IMAGE_EDITOR_ROTATE": "Rotate",
    "AssetAdmin.IMAGE_EDITOR_ROTATED": "Rotated to %s degrees",
    "AssetAdmin.IMAGE_EDITOR_SAVED": "Image updated.",
    "AssetAdmin.IMAGE_EDITOR_SAVED_WITH_BACKUP": "Image updated. Original backed up as \"%s\".",
    "AssetAdmin.IMAGE_EDITOR_TITLE": "Edit image",
    "AssetAdmin.IMAGE_EDITOR_TOOLBAR": "Image transform tools",
    "AssetAdmin.IMAGE_EDITOR_UNFLIPPED_HORIZ": "Horizontal flip removed",
    "AssetAdmin.IMAGE_EDITOR_UNFLIPPED_VERT": "Vertical flip removed",
    "AssetAdmin.IMAGE_EDITOR_WORKING": "Applying edit",
    "AssetAdmin.JOIN": ",",
    ...
    "AssetAdmin.NOT_EDITABLE": "not editable",
    "AssetAdmin.NOT_SELECTABLE": "not selectable",
    "AssetAdmin.NUM_ITEMS_THIS_PAGE": "{numFolders} folders and {numFiles} files on this page",
    "AssetAdmin.OR": "or",
    ...
    "AssetAdmin.SELECTABLE": "selectable",
    "AssetAdmin.SIZE": "Size",
    "AssetAdmin.TITLE": "Title",
    "AssetAdmin.TYPE": "File type",
    "AssetAdmin.UPLOADING_INSTRUCTION": "uploading, press enter to cancel",
    "AssetAdmin.UPLOAD_FAILED_INSTRUCTION": "upload failed, press enter to remove",
    "AssetAdmin.URL": "URL",
    "File.DRAFT": "Draft",
