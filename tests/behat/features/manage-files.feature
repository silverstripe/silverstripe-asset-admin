...
Feature: Manage files
  ...
  Scenario: I can add a new folder
    ...
    Then I should see the "folder" named "newfolder" in the gallery

  Scenario: I can list files in a folder
    When I click on the "folder" named "folder1" in the gallery
    Then I should see the "image" named "file1" in the gallery
      And I should see the "folder" named "folder1-1" in the gallery
      And I should not see the "image" named "file2" in the gallery

  Scenario: I can upload a file to a folder
    When I click on the "folder" named "folder1" in the gallery
      And I attach the file "testfile.jpg" to dropzone
    Then I should see the "image" named "testfile" in the gallery
  ...
  Scenario: I can edit a file
    ...
    Then I should see the "image" named "renamedfile" in the gallery
      And I should not see the "image" named "file1" in the gallery
